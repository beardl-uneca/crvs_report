...
chapter3_tables <- loadWorkbook("./outputs/excel/chapter3.xlsx", xlsxFile = NULL)
  ...
  mergeCells(chapter3_tables, sheet = "Table 3.3", cols = 3:(ncol(t3.3) + 1), rows = 2)
saveWorkbook(chapter3_tables,"./outputs/excel/chapter3.xlsx", overwrite = T)
...
chapter3_tables <- loadWorkbook("./outputs/excel/chapter3.xlsx", xlsxFile = NULL)
writeData(chapter3_tables, t3.8, sheet = "Table 3.8", startCol = 2, startRow = 4, colNames = FALSE)
mergeCells(chapter3_tables, sheet = "Table 3.8", cols = 2, rows = 2:3)
mergeCells(chapter3_tables, sheet = "Table 3.8", cols = 3:4, rows = 2)
mergeCells(chapter3_tables, sheet = "Table 3.8", cols = 5:6, rows = 2)
mergeCells(chapter3_tables, sheet = "Table 3.8", cols = 7:8, rows = 2)  
saveWorkbook(chapter3_tables,"./outputs/excel/chapter3.xlsx", overwrite = T)

chapter3_tables <- loadWorkbook("./outputs/excel/chapter3.xlsx", xlsxFile = NULL)
writeData(chapter3_tables, t3.9, sheet = "Table 3.9", startCol = 2, startRow = 4, colNames = FALSE)
mergeCells(chapter3_tables, sheet = "Table 3.9", cols = 2, rows = 2:3)
mergeCells(chapter3_tables, sheet = "Table 3.9", cols = 3:4, rows = 2)
mergeCells(chapter3_tables, sheet = "Table 3.9", cols = 5:6, rows = 2)
mergeCells(chapter3_tables, sheet = "Table 3.9", cols = 7:8, rows = 2)  
saveWorkbook(chapter3_tables,"./outputs/excel/chapter3.xlsx", overwrite = T)

chapter3_tables <- loadWorkbook("./outputs/excel/chapter3.xlsx", xlsxFile = NULL)
writeData(chapter3_tables, t3.10, sheet = "Table 3.10", startCol = 2, startRow = 4, colNames = FALSE)
mergeCells(chapter3_tables, sheet = "Table 3.10", cols = 2, rows = 2:3)
mergeCells(chapter3_tables, sheet = "Table 3.10", cols = 3:4, rows = 2)
mergeCells(chapter3_tables, sheet = "Table 3.10", cols = 5:6, rows = 2)
mergeCells(chapter3_tables, sheet = "Table 3.10", cols = 7:8, rows = 2)  
saveWorkbook(chapter3_tables,"./outputs/excel/chapter3.xlsx", overwrite = T)

chapter3_tables <- loadWorkbook("./outputs/excel/chapter3.xlsx", xlsxFile = NULL)
writeData(chapter3_tables, t3.11, sheet = "Table 3.11", startCol = 2, startRow = 4, colNames = FALSE)
mergeCells(chapter3_tables, sheet = "Table 3.11", cols = 2, rows = 2:3)
mergeCells(chapter3_tables, sheet = "Table 3.11", cols = 3:4, rows = 2)
saveWorkbook(chapter3_tables,"./outputs/excel/chapter3.xlsx", overwrite = T)

chapter3_tables <- loadWorkbook("./outputs/excel/chapter3.xlsx", xlsxFile = NULL)
writeData(chapter3_tables, t3.12, sheet = "Table 3.12", startCol = 2, startRow = 4, colNames = FALSE)
mergeCells(chapter3_tables, sheet = "Table 3.12", cols = 2, rows = 2:3)
mergeCells(chapter3_tables, sheet = "Table 3.12", cols = 3:4, rows = 2)
saveWorkbook(chapter3_tables,"./outputs/excel/chapter3.xlsx", overwrite = T)
